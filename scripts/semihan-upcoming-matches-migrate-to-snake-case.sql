-- Semihan upcoming_matches 테이블을 snake_case 스키마로 마이그레이션
...
DO $$
BEGIN
  RAISE NOTICE '✅ Semihan upcoming_matches 테이블이 snake_case 스키마로 마이그레이션되었습니다.';
  RAISE NOTICE '📊 Mission FC와 동일한 스키마를 사용합니다.';
END $$;
